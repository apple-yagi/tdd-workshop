...
class ClosedRangeTest extends TestCase
{
    ...
    {
        return [
            "整数閉区間は4を渡すとtrueを返せること" => [3, 7, 4],
            "整数閉区間は1を渡すとtrueを返せること" => [1, 100, 1],
            "整数閉区間は99を渡すとtrueを返せること" => [2, 99, 99],
        ];
    }
    ...
    {
        return [
            "整数閉区間は10を渡すとfalseを返せること" => [3, 7, 10],
            "整数閉区間は0を渡すとfalseを返せること" => [1, 100, 0],
            "整数閉区間は100を渡すとfalseを返せること" => [2, 99, 100],
        ];
    }
